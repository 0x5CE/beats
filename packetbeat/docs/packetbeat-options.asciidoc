...
[[packetbeat-mssql-options]]
=== Capture MSSQL traffic

++++
<titleabbrev>MSSQL</titleabbrev>
++++

The `mssql` section of the +{beatname_lc}.yml+ config file specifies configuration
options for the MSSQL protocols.
